...
public class WorldgenInfusedStone implements IWorldGenerator {
	...
	private void generateSurface(World world, Random random, int blockX,
		...
		for (int i = 0; i < SoulCraft.soulSpawnRate; i++) {

			int Xcoord = blockX + random.nextInt(16);
			int Ycoord = random.nextInt(40);
			int Zcoord = blockZ + random.nextInt(16);

			(new WorldGenMinable(SoulCraft.infusedStone, 4)).generate(world,
