...
public class ItemSoulShovel2 extends ItemSpade {

	public ItemSoulShovel2(ToolMaterial p_i45327_1_) {
		super(p_i45327_1_);

		this.setCreativeTab(SoulCraft.tabSoul);
		
		setTextureName("soulcraft:soulshovel2");

		
		GameRegistry.registerItem(this, "soulshovel2");
