...
public class ItemSpiderAxe extends ItemAxe {

	public ItemSpiderAxe(ToolMaterial p_i45327_1_) {
		super(p_i45327_1_);

		this.setCreativeTab(SoulCraft.tabSoul);
		
		setTextureName("soulcraft:spideraxe");
		
		GameRegistry.registerItem(this, "spideraxe");
