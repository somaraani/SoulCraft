...
public class ItemBoneShovel extends ItemSpade {

	public ItemBoneShovel(ToolMaterial p_i45327_1_) {
		super(p_i45327_1_);

		this.setCreativeTab(SoulCraft.tabSoul);
		
		setTextureName("soulcraft:boneshovel");

		
		GameRegistry.registerItem(this, "boneshovel");
