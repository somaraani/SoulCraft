...
public class ItemEnderShovel extends ItemSpade {

	public ItemEnderShovel(ToolMaterial p_i45327_1_) {
		super(p_i45327_1_);

		this.setCreativeTab(SoulCraft.tabSoul);
		
		setTextureName("soulcraft:endershovel");

		
		GameRegistry.registerItem(this, "endershovel");
