...
public class ItemZombieShovel extends ItemSpade {

	public ItemZombieShovel(ToolMaterial p_i45327_1_) {
		super(p_i45327_1_);

		this.setCreativeTab(SoulCraft.tabSoul);

		setTextureName("soulcraft:zombieshovel");

		GameRegistry.registerItem(this, "zombieshovel");

	}

	public boolean getIsRepairable(ItemStack par1ItemStack,
			ItemStack par2ItemStack) {
		return SoulCraft.soulFlesh == par2ItemStack.getItem() ? true : super
